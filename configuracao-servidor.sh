...
# Script para criar todas as pastas do /var/log/life , timedate, atualizar servidor
...
echo "(!) Script finalizado - criado pastas de log configurado timedate e atualizado sistema"
